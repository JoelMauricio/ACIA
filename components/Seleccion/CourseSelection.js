        ...
        <div className='h-auto m-6 bg-transparent flex flex-col gap-1 '>
            ...
            <div className="flex flex-col w-full h-full gap-4">
                <div className={section_format}>
                    <div className="rounded-md grid grid-flow-col justify-between h-15 w-full content-center">
                ...
                <div className={section_format}>
                    <div className="grid grid-flow-col h-15 w-full justify-between content-center">
