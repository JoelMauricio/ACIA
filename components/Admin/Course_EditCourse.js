...
const EditCourse = ({ course_id, name, code, credits, area, close }) => {
        ...
        <Form className="w-full" >
          ...
          <div className="flex flex-wrap w-full py-2">
            ...
            <div className={section_format}>
              ...
              {errors.courseName && touched.courseName ? (<p className={error_format}> {errors.courseName} </p>) : <p className='w-full h-[18px]'></p>}
            </div>
