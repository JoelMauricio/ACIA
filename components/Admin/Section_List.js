    ...
    return <>
        <div className='m-6 bg-transparent flex flex-col gap-5 overflow-hidden '>
            ...
            <div>
                ...
                <input className="input mr-8 shadow appearance-none border-2 border-mainBlack rounded-md w-[20rem] py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="search" value={search} onChange={FilterData} placeholder="Nombre o código de sección..."/>
                ...
                <div className="flex flex-wrap gap-2 max-h-full pr-2 overflow-y-auto overflow-hidden">
                    {filteredSections.map((section) => ( 
                        ...
                        <div className="flex w-fit gap-4 text-[18px] items-center px-2">
                            ...
                            <span className="ml-2 text-purBlue justify-items-start ">{section.Aula.nombre}</span>
