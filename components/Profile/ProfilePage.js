        ...
        <div className='m-6 bg-transparent flex flex-col gap-1 overflow-hidden' >
            ...
            {/* <div className='flex flex-col gap-4'>
                ...
                <div className="grid justify-center content-center ">
                    <button className="text-purBlue font-bold py-4 text-[20px] dark:text-purBlue cursor-pointer" onClick={handlePasswordRecovery} >Solicitar cambio de contraseña</button>
                </div>
                {profile?.id_rol === 2 ? (
