...
const MyProfile = () => {
    ...
    const section_format = 'bg-boneWhite last:shadow-lg w-full rounded-sm h-1/2 max-h-1/2 p-4 dark:bg-darkBD2'
    ...
    return <>
        <div className='m-6 bg-transparent flex flex-col gap-1 overflow-hidden' >
            ...
            <div className='bg-boneWhite last:shadow-lg w-full rounded-sm h-[250px] p-4 dark:bg-transparent'>
                <div className="flex h-full">
                    <div className="w-2/5 grid justify-center content-center">
                        <Avatar />
                    </div>
                    <div className="flex flex-wrap text-mainBlack text-[16px] font-semibold w-3/5 p-4 content-center dark:text-boneWhite">
            ...
            <div className="grid justify-center content-center ">
                <a className="text-blue font-bold py-4 dark:text-purBlue" onClick={null}>Solicitar cambio de contraseña</a>
            </div>
            {profile?.id_rol === 2 ? (
